...
static const int64_t DARKSEND_COLLATERAL = (1000*COIN); // 1,000 BZL
static const int64_t DARKSEND_FEE = (0.010000*COIN); //0.01 BZL
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 BZL
static const int64_t DARKSEND_POOL_MAX = (11000*COIN); //11,000 BZL
...
static const int LAST_POW_BLOCK = 3000000; // V1.0.1 / Block 3m Approx. 3 years of Proof of Work before Proof of Stake consensus kicks in
...
static const int64_t MAX_MONEY = 10850000 * COIN; // 10,580,000 BZL BZLCoin Max v2.0.0
static const int64_t COIN_YEAR_REWARD = 0.06 * COIN; // 6% per year

static const int64_t MAINNET_POSFIX = 300000; //Mainnet Proof of Stake update not enabled until block 300k
