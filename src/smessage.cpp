// Copyright (c) 2014 The BZLCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("bzlcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("bzlcoin-smsg-pow"); // Make this thread recognisable
